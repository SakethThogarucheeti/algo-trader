...
def test_indicator_aliases_registered() -> None:
    ...
    for alias in (
        "ema", "sma", "rsi", "atr", "vwap", "wilder_ema", "true_range",
        "macd", "bollinger", "stochastic", "cci", "williams_r", "roc",
        "momentum", "donchian", "keltner", "hv", "obv", "mfi", "cmf",
        "vwma", "pivot", "supertrend", "psar", "adx", "chaikin_vol",
    ):
